...
const LOOP_LEVELS = {
  ...
  beginner: [
    { arr: [3, 7, 2],
      ...
      task: 'Open <b>every</b> post box below, one at a time, adding what is inside to the jar as you go. When all the boxes are done, what number is in the jar?',
      keyLine: 3,
    ...
    { arr: null,
      ...
      task: 'The teacher calls out one number at a time, starting at <b>0</b> and stopping just <b>before</b> 5. Each time she calls a number, you tick once. How many ticks do you make?',
      keyLine: 1,
    ...
    { arr: [10, 20, 30, 40],
      ...
      question: 'How much did you collect in total?', opts: ['100', '60', '90'], ans: 1, correctVal: 60,
      task: 'Collect the money from the boxes below &mdash; but <b>stop before the last box</b> and never open it. How much do you collect altogether?',
      keyLine: 2,
  ...
  intermediate: [
    { arr: null,
      ...
      task: 'You do <b>3</b> rounds of work. Inside <b>each</b> round you tick <b>4</b> times before moving on. How many ticks altogether by the end?',
      keyLine: 2,
    ...
    { arr: null,
      ...
      task: 'Count along 0, 1, 2, 3 ... ticking once for each number. But the moment you reach <b>3</b> you walk out straight away, <b>without</b> ticking for it. How many ticks did you make?',
      keyLine: 3,
    ...
    { arr: null,
      ...
      task: 'Walk through 0, 1, 2, 3, 4. <b>Skip every even number completely</b> &mdash; add nothing for those. Add up only the ones you did not skip. What is the total?',
      keyLine: 3,
  ...
  pro: [
    { arr: null,
      ...
      task: 'Walk along the row [1, 2, 2, 3] from the left, throwing out every <b>even</b> number you meet. Careful: each time you throw one out, everything to its right slides one place left &mdash; but you carry on walking forward from where you were. What is left in the row at the end?',
      keyLine: 3,
    ...
    { arr: null,
      ...
      task: 'Start at <b>0</b> and jump forward <b>3</b> at a time, stopping before you reach <b>10</b>. Every number you land on gets written down. How many numbers do you write down?',
      keyLine: 1,
    ...
    { arr: null,
      ...
      task: 'A counter <b>i</b> starts at 0. Each step you add <b>2</b> to it. You keep taking steps for as long as i is <b>under 5</b>. How many steps do you take before you stop?',
      keyLine: 2,
